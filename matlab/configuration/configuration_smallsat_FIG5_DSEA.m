function config = configuration_smallsat_FIG5_DSEA
%Constants and configuration definitions for the satellite
    ...
    config.controller.W_wie = [0.001;0.1;0.1;0.1]; % Damping values for comparison with Wie 2005
    ...
    % Target direction
    config.controller.target_direction = [1;0;0];           % X roll maneuver
