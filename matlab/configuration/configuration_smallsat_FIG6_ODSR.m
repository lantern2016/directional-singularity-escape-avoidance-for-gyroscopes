function config = configuration_smallsat_FIG6_ODSR
%Constants and configuration definitions for the satellite
    ...
    config.simulation.initialGimbalAnglesDegrees  = [-90;180;90;0]; % Initial conditions to simulate start in external singularity


    %Timing
    config.simulation.t_end = 10;
    ...
    % Target direction
    config.controller.target_direction = [-1;0;0]; % Reference moment along -X axis
