function config = configuration_smallsat_FIG7_DSEA
%Constants and configuration definitions for the satellite
    ...
    % Target direction
    config.controller.target_direction = nan(3,1);           % Not applicable
...
%     config.functions.get_Mref  = @get_Mref_for_constant_M;
    ...
    % Environment
    config.model.M_e_disturbance = [0.5;0;0];
